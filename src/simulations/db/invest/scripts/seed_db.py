...
async def seed_data():
    ...
    async with AsyncSessionLocal() as session:
        ...
        strategies = []
        templates = [
            ("Ультра-консервативная", 8.0, "Low", "ОФЗ, Гособлигации"),
            ("Сбалансированный портфель", 14.5, "Medium", "ОФЗ, Корпоративные облигации, Акции голубых фишек"),
            ("Дивидендная зарплата", 16.0, "Medium", "Дивидендные акции РФ, Облигации"),
            ("Агрессивный рост", 25.0, "High", "Акции роста, IPO, Фьючерсы"),
            ("Технологический прорыв", 30.0, "High", "Акции IT сектора, Опционы"),
            ("Антикризисная", 12.0, "Low", "Золото, ОФЗ, Валютные активы"),
            ("Долговой рынок", 11.5, "Low", "ВДО, Корпоративные облигации"),
            ("Крипто-тренд", 80.0, "High", "Криптовалюта, Фьючерсы на биткоин"),
            ("Сырьевой цикл", 20.0, "Medium", "Нефть, Газ, Металлурги"),
            ("Финансовый сектор", 18.0, "Medium", "Акции банков и финтех-компаний"),
            ("Ритейл и потребление", 15.0, "Medium", "Акции ритейла, FMCG"),
            ("Инфраструктура", 13.0, "Low", "Транспорт, Энергетика"),
            ("Защитная гавань", 9.0, "Low", "Золото, Фонды денежного рынка"),
            ("Высокодоходные облигации", 22.0, "Medium", "Мусорные облигации (ВДО)"),
            ("Моментум-трейдинг", 40.0, "High", "Торговля по тренду, Шорт, Маржиналка"),
            ("Глобальный сдвиг", 28.0, "High", "Валютные пары, Фьючерсы на индексы"),
            ("Пассивный доход", 10.0, "Low", "ПИФы недвижимости, ОФЗ"),
            ("Венчур и стартапы", 60.0, "High", "Pre-IPO, Краудлендинг"),
            ("Эко-тренд (ESG)", 14.0, "Medium", "Зеленая энергетика"),
            ("Спекулятивная", 50.0, "High", "Интрадей трейдинг, Опционы")
        ]
